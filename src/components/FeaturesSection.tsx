      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-16">
          {features.map((feature, index) => (
            <Card key={index} className="group hover:shadow-card transition-all duration-300 border-glass bg-gradient-card backdrop-blur-sm">
          ...
          <div className="bg-gradient-card backdrop-blur-glass border border-glass rounded-2xl p-8 max-w-2xl mx-auto">
            ...
            <div className="flex items-center justify-center gap-8 mb-6">
              ...
              <div className="text-center">
                ...
                <div className="text-sm text-muted-foreground/80">Unlimited EPKs, custom branding</div>
              </div>
            </div>
