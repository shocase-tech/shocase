...
import { Save, X, Plus, ExternalLink, Loader2 } from "lucide-react";
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      const { error } = await supabase
        ...
        .update({ press_mentions: mentions as any })
        .eq('user_id', user.id);
      ...
      toast({
        title: "Success!",
        description: "Press mentions updated successfully.",
      });
